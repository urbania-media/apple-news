...
use Urbania\AppleNews\Format\FlexibleSpacer;
use Urbania\AppleNews\Tests\TestCase;

/**
 * @coversDefaultClass \Urbania\AppleNews\Format\FlexibleSpacer
 */
class FlexibleSpacerTest extends TestCase
{
    /**
