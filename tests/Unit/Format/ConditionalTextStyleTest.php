...
use Urbania\AppleNews\Format\ConditionalTextStyle;
use Urbania\AppleNews\Tests\TestCase;

/**
 * @coversDefaultClass \Urbania\AppleNews\Format\ConditionalTextStyle
 */
class ConditionalTextStyleTest extends TestCase
{
    /**
