 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/tiktok.json
 */
class TikTok extends Component
{
    /**
     * Always tiktok for this component.
     * @var string
     */
    protected $role = 'tiktok';

    /**
     * The URL of the TikTok post you want to embed.
