...
/**
 * The object for defining conditional properties for a divider
 * component, and when the conditional properties are in effect.
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/conditionaldivider.json
 */
class ConditionalDivider extends ConditionalComponent
{
    /**
     * An instance or array of conditions that, when met, cause the
     * conditional divider component properties to take effect.
