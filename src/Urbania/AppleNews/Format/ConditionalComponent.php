...
/**
 * The object for defining conditional properties for a component, and
 * when the conditional properties are in effect.
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/conditionalcomponent.json
 */
class ConditionalComponent extends BaseSdkObject
{
    /**
