 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/section-ka8.json
 */
class Section extends Container
{
     ...
     * allowing a link to anywhere in News. Adding a link to a section
    ...
    /**
     * An instance or array of section properties that can be applied
     * conditionally, and the conditions that cause them to be applied.
     * @var Format\ConditionalSection[]|\Urbania\AppleNews\Format\ConditionalSection
     */
    protected $conditional;

    /**
     * An object that defines how to position child components within this
     * section component. A , for example, allows for displaying child
    ...
    /**
     * Get the conditional
     * @return Format\ConditionalSection[]|\Urbania\AppleNews\Format\ConditionalSection
     */
    ...
    /**
     * Set the conditional
     * @param Format\ConditionalSection[]|\Urbania\AppleNews\Format\ConditionalSection|array $conditional
     * @return $this
     */
    public function setConditional($conditional)
    {
        ...
        if (is_object($conditional) || Utils::isAssociativeArray($conditional)) {
            Assert::isSdkObject($conditional, ConditionalSection::class);
        } else {
        ...
        $this->conditional = Utils::isAssociativeArray($conditional)
            ? new ConditionalSection($conditional)
            : $conditional;
        return $this;
    }
