...
/**
 * The component for redistributing empty space inside a horizontal stack
 * collection.
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/flexiblespacer.json
 */
class FlexibleSpacer extends Component
{
     ...
     * The width of the spacer is determined automatically based on any
     * remaining horizontal space, and the height is that of the parent
     * container. Any top or bottom margins specified on a spacer component's
     * layout decreases the height of the layout within the parent container.
     * All properties of ComponentLayout object are supported except
     * minimumHeight and minimumWidth.
