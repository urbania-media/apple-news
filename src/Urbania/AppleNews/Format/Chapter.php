...
class Chapter extends Container
{
    ...
    /**
     * A value that defines how child components are positioned within this
     * chapter component. For example, this property can allow for displaying
     * child components side-by-side and can make sure they are sized
     * equally.
