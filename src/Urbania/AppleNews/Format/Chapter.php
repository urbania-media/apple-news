 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/chapter.json
 */
class Chapter extends Container
{
     ...
     * allowing a link to anywhere in News. Adding a link to a chapter
     ...
     * chapter component. A , for example, allows for displaying child
