 ...
 * section.
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/header.json
 */
class Header extends Container
{
    ...
    /**
     * An array of additions. This can be used to create a , allowing links
     * to anywhere in News.
     * Adding a link to a  component makes the entire component tappable. Any
     * links used in its child components are not tappable.
     ...
     * container component. A , for example, allows for displaying child
     ...
     * If layout is not defined, size and position are be based on various
