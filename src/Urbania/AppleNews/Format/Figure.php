 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/figure.json
 */
class Figure extends Component
{
     ...
     * reference to a ComponentLayout that is defined at the top level of the
     * document.
