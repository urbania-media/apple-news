...
/**
 * The component for adding a web video from Dailymotion, Vimeo, or
 * YouTube.
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/embedwebvideo.json
 */
class EmbedWebVideo extends Component
{
    ...
    /**
     * The URL of the embeddable video to display (the Dailymotion, Vimeo, or
     * YouTube embed link). The embed URL is usually different from the
     * standard video URL.
     * A Dailymotion embed URL typically looks like this:
     * https://geo.dailymotion.com/player.html?video=x84sh87
     * A Vimeo embed URL typically looks like this:
     * https://player.vimeo.com/video/121450839
     * A YouTube embed URL typically looks like this:
    ...
    /**
     * A caption that describes the content of the embedded web video. The
     * text is used for VoiceOver. For more information about VoiceOver, see
     * the  page in Accessibility. If accessibilityCaption is not provided,
     * the caption value is used for VoiceOver for iOS, VoiceOver for iPadOS,
     * and VoiceOver for macOS.
     * @var string
     */
    ...
    /**
     * A caption that describes the content of the embedded web video. This
     * text is used by VoiceOver if accessibilityCaption is not provided, or
     * it can be shown when the embedded web video cannot be played.  For
     * more information about VoiceOver, see the  page in Accessibility.
     * @var string
     */
    protected $caption;
    ...
    /**
     * A Boolean value that indicates that the embedded web video may contain
     * explicit content.
     * @var boolean
     */
