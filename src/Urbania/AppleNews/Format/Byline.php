 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/byline.json
 */
class Byline extends Text
{
     ...
     * should supply a rangeStart, rangeLength, and either a TextStyle object
     * or the identifier of a TextStyle that is defined at the top level of
     * the document.
