 ...
 *
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/replicaadvertisement.json
 */
class ReplicaAdvertisement extends Component
{
    /**
     * Always replica_advertisement for this component.
     * @var string
     */
    protected $role = 'replica_advertisement';

    /**
     * The URL of the digital version of the print advertisement.
     * The URL can begin with http://, https://, or bundle://. If it begins
     * with bundle://, the digital version of the print advertisement file
     * must be in the same directory as the document.
     * Digital version of the print advertisement filenames should be
     * properly encoded as URLs.
     * See .
     * @var string
     */
    protected $URL;
    ...
    /**
     * A caption that describes the digital version of the print
     * advertisement. The text is used for VoiceOver. For more information
     * about VoiceOver, see the  page in Accessibility.  If
    ...
    /**
     * A caption that describes the digital version of the print
     * advertisement. The article displays this text when the digital version
     * of the print advertisement is full screen, and VoiceOver uses this
     * text if you don’t provide accessibilityCaption text. For more
     * information about VoiceOver, see the  page in Accessibility. The
     * caption text doesn’t appear in the main article view. To display a
     * caption in the main article view, use the  component.
    ...
    /**
     * A Boolean value that indicates the digital version of the print
     * advertisement may contain explicit content.
     * @var boolean
     */
