 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/heading.json
 */
class Heading extends Text
{
    /**
     * Always one of these roles for this component: heading, heading1,
     * heading2, heading3, heading4, heading5, or heading6.
     * @var string
     */
