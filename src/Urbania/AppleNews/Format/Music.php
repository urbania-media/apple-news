 ...
 *
 * @see https://developer.apple.com/tutorials/data/documentation/apple_news/music.json
 */
class Music extends Component
{
     ...
     * all  audio formats, including the following:
     * @var string
     */
    protected $URL;

    /**
     * A caption that describes the content of the audio file. The text is
    ...
    /**
     * A caption that describes the content of the audio file. This text is
     * used by VoiceOver if accessibilityCaption is not provided, or it can
     * be shown when the audio cannot be played.  For more information about
    ...
    /**
     * A Boolean value that indicates that the audio may contain explicit
     * content.
     * @var boolean
     */
